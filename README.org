...
* ★★★★☆ CSV with a schema
  Let's continue to make our CSV even more self-describing.
...
** An explicit description of types
   1. We introduced ISO 8601 timestamps, but how does a client /know/ that the first column of =schedule.csv= is an ISO 8601 timestamp?
...
: 2014-08-25T09:00:00+02:00,Introduction,,,
   ...
   2. We introduced a vocabulary, but how do we make explicit what we mean by “label”, “description” and “see also”?

   Let's explicitly indicate the types!

   1. for the timestamps and other entries in the schedule:
...
: ,2014-08-25T09:00:00+02:00,Introduction,,,
   ...
   2. for the properties of vocabulary terms:
